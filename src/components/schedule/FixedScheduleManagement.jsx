...
          setMessageModalContent({
            title: 'Error de Data',
            message: `La data d'inici del nou horari (${formatDateDDMMYYYY(newScheduleEntryData.startDate)}) ha de ser posterior a l'últim horari existent (${formatDateDDMMYYYY(latestExistingSchedule.startDate)}).`,
            isConfirm: false,
            onConfirm: () => setShowMessageModal(false),
          });
          setShowMessageModal(true);
...
            <h2 className="text-xl font-semibold text-gray-800 mb-2">Horari des de: {formatDateDDMMYYYY(scheduleEntry.startDate)}</h2>
            <div className="mb-4">
